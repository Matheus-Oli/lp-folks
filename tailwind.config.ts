  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Folks Ecossistema Brand Colors
        moss: "hsl(var(--moss))",
        "moss-foreground": "hsl(var(--moss-foreground))",
        teal: "hsl(var(--teal))",
        "teal-foreground": "hsl(var(--teal-foreground))",
        aqua: "hsl(var(--aqua))",
        "aqua-foreground": "hsl(var(--aqua-foreground))",
        sand: "hsl(var(--sand))",
        "sand-foreground": "hsl(var(--sand-foreground))",
        gold: "hsl(var(--gold))",
        "gold-foreground": "hsl(var(--gold-foreground))",
        "off-white": "hsl(var(--off-white))",
        "off-white-foreground": "hsl(var(--off-white-foreground))",
